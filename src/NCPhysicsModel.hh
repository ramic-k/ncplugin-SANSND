...
namespace NCPluginNamespace {
  ...
  public:
    ...
    PhysicsModel( const NC::Info& info, Model model, NC::VectD param, double thetaMinRad = 0.0 );
    //Constructor gets the models string and the dist R file or input I(q) file:
    PhysicsModel( const NC::Info& info, Model model, std::string filename, double thetaMinRad = 0.0 );
